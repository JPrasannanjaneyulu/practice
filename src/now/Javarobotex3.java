...
public class Javarobotex3 
{
	public static void main(String[] args) throws InterruptedException, AWTException 
	{
		...
		Thread.sleep(5000);
		driver.findElement(By.name("password")).sendKeys("janjanam@rp");
		driver.findElement(By.xpath("//*[text()='Next']")).click();
		Thread.sleep(5000);
		//Click compose
		...
		driver.findElement(By.xpath("//div[@aria-label='Message Body']")).sendKeys("Hi sir,", Keys.ENTER, "How are you in ", Keys.ENTER, "Regards:", Keys.ENTER, "Prasanna");
		Thread.sleep(5000);
